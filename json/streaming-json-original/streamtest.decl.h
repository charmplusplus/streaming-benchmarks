...
class CkIndex_Readers:public CkIndex_ArrayElement{
  public:
    ...
    /* DECLS: Readers(int num_records, const std::string &records_str);
     */
    // Entry point registration at startup
    ...
    static int ckNew(int num_records, const std::string &records_str) { return idx_Readers_marshall2(); }
 ...
 */
    ...
    void insert(int num_records, const std::string &records_str, int onPE=-1, const CkEntryOptions *impl_e_opts=NULL);
/* DECLS: void setOutputStreamId(const StreamToken &output_id);
 */
 ...
 */
    ...
    static CkArrayID ckNew(int num_records, const std::string &records_str, const CkArrayOptions &opts = CkArrayOptions(), const CkEntryOptions *impl_e_opts=NULL);
    static void      ckNew(int num_records, const std::string &records_str, const CkArrayOptions &opts, CkCallback _ck_array_creation_cb, const CkEntryOptions *impl_e_opts=NULL);
    static CkArrayID ckNew(int num_records, const std::string &records_str, const int s1, const CkEntryOptions *impl_e_opts=NULL);
    static void ckNew(int num_records, const std::string &records_str, const int s1, CkCallback _ck_array_creation_cb, const CkEntryOptions *impl_e_opts=NULL);
...
class CkIndex_Writers:public CkIndex_ArrayElement{
  public:
    ...
    static int reg_Writers_void();
    // Entry point index lookup
    
    inline static int idx_Writers_void() {
      static int epidx = reg_Writers_void();
      return epidx;
    }

    
    static int ckNew() { return idx_Writers_void(); }
    
    static void _call_Writers_void(void* impl_msg, void* impl_obj);
    
    static void _call_sdag_Writers_void(void* impl_msg, void* impl_obj);
    /* DECLS: void setInputStreamId(const StreamToken &input_id);
     */
    // Entry point registration at startup
